module Associations::ApprovalCycle::Setup
  ...
  included do
    ...
    ApprovalCycle.configuration.approval_cycle_setup_types.each_key { |type| has_many type.to_s.pluralize.to_sym, class_name: type.to_s.classify, foreign_key: "approval_cycle_setup_id" }
  end
end
